  ...
  if (BOB.shaders.enabled)
  {
    ...
    if (!is_cached)
    {
      const char *cmd =
        ...
        // Precompile shaders
        "dxc ../src/game/shader_world.hlsl /E WORLD_DxShaderVS /T vs_6_0 /Fh ../gen/gen_shader_world.vert.h && "
        "dxc ../src/game/shader_world.hlsl /E WORLD_DxShaderPS /T ps_6_0 /Fh ../gen/gen_shader_world.frag.h && "
